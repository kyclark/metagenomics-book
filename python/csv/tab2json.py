...
def get_args():
    ...
    parser.add_argument('tabfile', metavar='str', nargs='+',
    ...
    parser.add_argument('-o', '--outdir', help='Output dir',
                        metavar='str', type=str, default='')
    parser.add_argument('-i', '--indent', help='Indent level',
                        metavar='int', type=int, default=2)
    parser.add_argument('-n', '--normalize_headers', help='Normalize headers', 
                        action='store_true')
...
def main():
    ...
    for i, tabfile in enumerate(tabfiles):
